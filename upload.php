...
if ($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    echo " <font color=red>This file has been uploaded successfully</font><br>The address is:  <font color=blue>http://localhost/new/".$destination_folder.$fname."</font><br>";
    echo "<br> Size:".$file["size"]." bytes";
	echo '<br>';
	//将数据插入到数据库中
	$address = "http://localhost/"."$destination_folder"."$fname";
	$name = $file['name'];
